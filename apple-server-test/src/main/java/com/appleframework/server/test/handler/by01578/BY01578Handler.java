 ...
 * @author ohun@live.cn
 */
public final class BY01578Handler implements MessageHandler {
    ...
    static {
    	register(BY015CMD.LOGIN, new BY01578LoginProtocol());
    	register(BY015CMD.GPS, new BY01578GpsProtocol());
